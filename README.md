...
[![Deploy to Cloudflare](https://deploy.workers.cloudflare.com/button)](https://deploy.workers.cloudflare.com/?url=https://github.com/cloudflare/templates/tree/main/shrill-paper-116d)
...
```
npm create cloudflare@latest -- --template=cloudflare/templates/shrill-paper-116d
```

A live public deployment of this template is available at [https://shrill-paper-116d.templates.workers.dev](https://shrill-paper-116d.templates.workers.dev)
